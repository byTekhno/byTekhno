...
| [testgrow-internet-bank-qa](https://github.com/byTekhno/testgrow-internet-bank-qa) | Учебный интернет-банк (Test Grow) | Smoke **3/2** · run **Pass 22 / Fail 10 / Blocked 3 / Skipped 3** · кейсы: авторизация, счета, перевод, регресс. **BUG-006 — На границе лимита перевод выполняется, хотя показывается ошибка (RUB, EUR)**
